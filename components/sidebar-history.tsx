...
export function SidebarHistory({ user }: { user: User | undefined }) {
  ...
  if (!user) {
    return (
      <SidebarGroup>
        <SidebarGroupContent>
          <div className="flex flex-row items-center justify-center w-full gap-2 px-2 text-sm text-zinc-500">
        ...
        <SidebarGroupContent>
          <div className="flex flex-col">
            {[44, 32, 28, 64, 52].map((item) => (
              <div
                key={item}
                className="flex items-center h-8 gap-2 px-2 rounded-md"
              >
                <div
